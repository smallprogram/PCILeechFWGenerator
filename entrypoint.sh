...
if [ "$1" = "--help" ] || [ "$1" = "-h" ]; then
    ...
    echo "  sudo python3 /app/src/build.py --bdf 0000:03:00.0 --board 75t --device-type storage"
    echo ""
    echo "  # Minimal build (disable advanced features)"
    echo "  sudo python3 /app/src/build.py --bdf 0000:03:00.0 --board 75t --disable-advanced-sv --disable-variance"
    echo ""
    echo "  # Custom device type with all production features"
    echo "  sudo python3 /app/src/build.py --bdf 0000:03:00.0 --board 75t --device-type graphics"
    echo ""
