...
if [ "$1" = "--help" ] || [ "$1" = "-h" ]; then
    ...
    echo "  sudo python3 /app/pcileech.py build --bdf 0000:03:00.0 --board 75t"
    echo ""
    ...
    echo "  sudo python3 /app/pcileech.py build --bdf 0000:03:00.0 --board 75t --device-type graphics"
    echo ""
