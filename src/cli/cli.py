...
def choose_board() -> str:
    ...
    try:
        from src.board_config import list_supported_boards, get_board_info
    except ImportError:
        # Fallback to hardcoded list if import fails
        supported_boards = [
            "pcileech_75t484_x1", "35t", "75t", "100t",
            "pcileech_35t484_x1", "pcileech_35t325_x4", "pcileech_35t325_x1",
            "pcileech_100t484_x1", "pcileech_enigma_x1", "pcileech_squirrel",
...
def create_build_config_from_args(args: argparse.Namespace) -> BuildConfig:
    ...
    from .vfio import get_iommu_group, get_current_driver
    ...
    return BuildConfig(
        ...
        disable_ft601=args.disable_ft601,
        flash=args.flash,
...
def setup_build_parser(subparsers) -> argparse.ArgumentParser:
    ...
    build_parser.add_argument(
        ...
        choices=[
            ...
            "pcileech_35t325_x1", "pcileech_100t484_x1", "pcileech_enigma_x1",
            "pcileech_squirrel", "pcileech_pciescreamer_xc7a35",
        ],
    ...
    build_parser.add_argument(
        ...
        action="store_true",
        default=True,
        help="Enable FT601 USB-3 capture functionality (default: enabled)",
    )

    build_parser.add_argument(
        "--disable-ft601",
        action="store_true",
        help="Disable FT601 USB-3 capture functionality (not supported for pcileech_75t484_x1)",
    )
...
def setup_flash_parser(subparsers) -> argparse.ArgumentParser:
    ...
    flash_parser.add_argument(
        'firmware_path',
        help='Path to firmware binary file (e.g., output/firmware.bin)'
    )
...
def parse_args(args: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    if not parsed_args.command:
        ...
        parsed_args.enable_ft601 = True
        parsed_args.disable_ft601 = False
